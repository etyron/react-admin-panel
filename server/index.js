...
let ActiveUsersLastYear = [ 220.0, 260.0, 220.0, 400.0, 380.2, 720.0, 400, 430, 460, 270,230];
let ActiveUsersLastMonth = [ 20.0, 28.0, 35.0, 49.0, 28, 55.0, 21.2, 40, 45, 49];
let ActiveUsersLastWeek = [12, 12, 9, 8, 9, 12, 20, 21, 5, 6, 8, 10,16, 22, 28];
...
App.get('/api/active/last-year', (req, res) => {
    return res.json(
        ActiveUsersLastYear
    )
});

App.get('/api/active/last-month', (req, res) => {
    return res.json(
        ActiveUsersLastMonth
    )
});

App.get('/api/active/last-week', (req, res) => {
    return res.json(
        ActiveUsersLastWeek
    )
});
